...
\section{\label{sect:theory}Theory}
  \subsection{Diffraction \& Interference}
    ...
    \subsection{Spectral lines}
      ...
      The spectral lines of hydrogen, and other hydrogen-like elements are predicted by Eqn. \ref{eqn:Rydenberg}, The Rydenberg formula, where $Z$ denotes the atomic number of the element, $R=1.09737\times10^{7}\,\textup{m}^{-1}$ the Rydenberg constant and $n', n$ speciffic integers which determine the series and speciffic line respectively. For hydrogen, the visible lines are found in the Balmer series, $n'=2$ and $n=3, 4, 5, \dots$
      \begin{equation}
