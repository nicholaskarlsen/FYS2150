...
\section{\label{sect:theory}Theory}
  \subsection{Diffraction \& Interference}
    ...
    For two parallel slits with a distance A between, the intensity is instead given by Eqn. \ref{eqn:para_E}, which will have intensity minima when either $au = n$ for nonzero $n \in \mathbb Z$ or $Au = 2n$ for $n \in \mathbb Z$.
...
\section{\label{sect:results}Results}
    ...
    \subsection{\label{subsect:res_Zeeman}Zeeman Effect}
      ...
      The pictures taken of the split diffraction lines are shown in Fig.\ref{fig:zeeman_pics} and the associated results computed using zeemanread.py (see appendix \ref{app:scripts}) are shown in Table \ref{tab:zeeman_table}. The image shown in Fig. \ref{fig:zeeman_1A} could not be successfully processed by my script, and is therefore not included in Table \ref{tab:zeeman_table}.
      ...
      \begin{table}[H]
        ...
        \begin{tabular}{ l  l  l  l  l  l }
          ...
          4 & 685.5 & 423.5 & 524.5 & 661.0 & $8.977\cdot 10^{-27}$ \\
          3 & 526.5 & 437.0 & 515.0 & 668.5 & $9.123\cdot 10^{-27}$ \\ 
          2 & 354.5 & 450.0 & 503.0 & 677.5 & $9.195\cdot 10^{-27}$ \\ 
        \end{tabular}
