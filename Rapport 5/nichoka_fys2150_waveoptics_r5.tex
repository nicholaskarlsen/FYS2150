...
\section{\label{sect:intro}Introduction}
  This report contains a summary and analysis of a lab day in which my lab and I partner performed experiments in which we explored how measurements could be made using the wave-like behavior of light, in particular, diffraction and interference.
...
\section{\label{section:experimental}Experimental Procedure} 
    ...
    \subsection{Zeeman effect\label{sect:zeeman_expt}}
      \begin{figure}[H]
        ...
        \caption{Simplified FP-interferometer}
    ...
    \subsection{\label{subsect:res_Zeeman}Zeeman Effect}
      ...
      \begin{table}[H]
        ...
        \begin{tabular}{ l  l  l  l  l  r }
          ...
          1 & 176.0 & $463 \pm 1$ & $489 \pm 1$ & $686 \pm 1$ & $9.086\pm 0.498\cdot 10^{-24}$ \\  \hline
...
\section{\label{sect:discuss}Discussion}
  ...
  \subsection{Comparison of measured $\mu_B$ and reference value}
