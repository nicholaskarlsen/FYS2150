...
\section{\label{sect:results}Results}
  ...
  \begin{figure}[H]
    \center
    \subfloat[][$v_c$ against $F_g/r$]{\includegraphics[scale=0.75]{scripts/figs/v_fgr.png}\label{}}\\
    \subfloat[][$v_c^2$ against $F_g/r^2$]{\includegraphics[scale=0.75]{scripts/figs/v2_fgr2.png}\label{}}
  ...
  \end{figure}
    ...
    \begin{figure}[H]
    \center
    \subfloat[][$C_R$ against $R_e$]{\includegraphics[scale=0.75]{scripts/figs/CR_RE.png}\label{}}
    \\
    \subfloat[][$C_S$ against $R_e$]{\includegraphics[scale=0.75]{scripts/figs/CS_RE.png}\label{}}
