function [DS,devicename]=initDaqSessions(Nsessions,Duration,SampleRate,Sound)
...
for session = 1:Nsessions
    DS(session).Rate = SampleRate;
    DS(session).DurationInSeconds=Duration;
end
