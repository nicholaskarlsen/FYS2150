...
\section{\label{sect:theory}Theory}
  ...
  \subsection{Polarization}
    The polarization of light is a wave-like property of which essentially describe the direction in which the light waves oscillate as they propagate.
    ...
    Experimentally, a polarization filter can be used to filter out light in a specific direction, in which case it is referred to as a polarizer. Or it can be used to determine the direction of polarization, in which case it is referred to as an analyzer.


  \subsection{The Brewster angle}
    When light hits a reflective surface, it is partially reflected and transmitted. For a particular angle of incidence, light which is polarized at paralell to the plane of incidence is fully transmitted. This angle is named the Brewster angle, $\phi_B$ and is defined mathemtaically in Eqn. \ref{eqn:brewster}. In particular, when a wave goes from Air to another medium, such as glass, the equation simplifies to $\tan \phi_B \approx n_2$, as the refractive index of air is $n_{air}\approx 1$. Which is derived from Snell's Law. For more, see \cite{bolger}.
    \begin{equation}
...
\section{\label{section:experimental}Experimental Procedure} 
  ...
  \subsection{Light transmitted through an angled glass plate}
    ...
    \begin{figure}[h!]
      ...
      \caption{Aparature used to investigate the polarization angles of light transmitted through an angled glass plate}
...
\section{\label{sect:results}Results}
  ...
  Using the relation for Brewsters angle in Eqn. \ref{eqn:brewster}, and asuming an uncertainty in the angle of $\pm2^\circ$, the refractive intex, $n$ of the glass prism is $\tan(\phi_B + 90^\circ) \approx 1.4 \pm 0.1 = n$.
